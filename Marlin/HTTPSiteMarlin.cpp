...
void
HTTPSiteMarlin::SetXFrameOptions(XFrameOption p_option,CString p_uri)
{
...
// HSTS options
void
HTTPSiteMarlin::SetStrictTransportSecurity(unsigned p_maxAge,bool p_subDomains)
{
...
void
HTTPSiteMarlin::SetXContentTypeOptions(bool p_nosniff)
{
  m_xNoSniff = p_nosniff;
}

void
HTTPSiteMarlin::SetXSSProtection(bool p_on,bool p_block)
{
...
void
HTTPSiteMarlin::SetBlockCacheControl(bool p_block)
{
...
void
HTTPSiteMarlin::AddSiteOptionalHeaders(UKHeaders& p_headers)
{
  CString value;
